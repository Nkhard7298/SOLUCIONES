 ...
 * @author Compaq
 */
public class TakeAttendance1 extends javax.swing.JFrame {

    /**
     * Creates new form TakeAttendance1
     */
    public TakeAttendance1() {
        initComponents();
...
//String sql = "SELECT student_idstudent, count(CASE WHEN  status = 'Present'  then 1 END)/count(*)*100 as percentage FROM attendence where student_subject_subjectid = 102 group by student_idstudent";
 try {
    ...
    conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1434;database=bios;user=sa;password=opk16168");
...
jTable2.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakeAttendance1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TakeAttendance1().setVisible(true);
            }
        });
    }
